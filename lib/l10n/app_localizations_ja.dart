...
class AppLocalizationsJa extends AppLocalizations {
  ...
  @override
  String get deleteTransactionMessage => 'この取引を削除してもよろしいですか？';

  @override
  String get transactionDeleted => '取引が正常に削除されました';

  @override
  String get transactionSaved => '取引が正常に保存されました';
  ...
  @override
  String get registrationFailed => '登録に失敗しました。もう一度お試しください。';
  ...
  @override
  String get weeklyBreakdown => '週次内訳';

  @override
  String get monthlyComparison => '月次比較';
  ...
  @override
  String get categoryTotals => 'カテゴリ合計';
  ...
  String get privacyPolicyContent =>
      'あなたのプライバシーは私たちにとって重要です。すべてのデータはあなたのデバイスにローカルに保存され、第三者と共有されることはありません。\n\n個人情報の収集、保存、送信は一切行いません。あなたの財務データはデバイス上でプライベートかつ安全に保たれます。';
